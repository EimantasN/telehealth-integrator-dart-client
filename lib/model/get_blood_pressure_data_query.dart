...
class GetBloodPressureDataQuery {
  ...
  /// Returns a new [GetBloodPressureDataQuery] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetBloodPressureDataQuery? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetBloodPressureDataQuery[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetBloodPressureDataQuery[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetBloodPressureDataQuery> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetBloodPressureDataQuery.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetBloodPressureDataQuery> mapFromJson(dynamic json) {
    final map = <String, GetBloodPressureDataQuery>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetBloodPressureDataQuery.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GetBloodPressureDataQuery-objects as value to a dart map
