...
class GetSleepDataQuery {
  ...
  @override
  String toString() => 'GetSleepDataQuery[isDoctor=$isDoctor, start=$start, end=$end, groupByMonth=$groupByMonth, awake=$awake, light=$light, deep=$deep, score=$score, duration=$duration]';
