...
class DeviceFullDto {
  ...
  @override
  String toString() => 'DeviceFullDto[type=$type, model=$model, modelId=$modelId, battery=$battery, deviceid=$deviceid, hashDeviceid=$hashDeviceid, timezone=$timezone, lastSessionDate=$lastSessionDate, active=$active, measures=$measures]';
